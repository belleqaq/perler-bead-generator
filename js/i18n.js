...
const I18N = {
  zh: {
    ...
    'image.mode-sample': '净边采样',
    'image.mode-sample-hint': '？',
    'image.bg-tol': '去背景容差',
    'image.bg-local': '本地抠图',
    'image.bg-ai': 'AI 抠图',
    'image.bg-restore': '还原',
    'image.bg-busy': 'AI 抠图中…',
    'image.bg-done': '已去背景',
    'image.bg-fail': '抠图失败：',
    'image.bg-restored': '已还原原图',
    'image.precision': '精细度',
    ...
    'image.style': '风格',
    'image.style-none': '原图',
    'image.style-8bit': '8-bit 复古',
    'image.style-comic': '漫画描边',
    'image.style-watercolor': '水彩',
    'image.style-noir': '单色版画',

    'ai.title': 'AI 真人转卡通（高级）',
    'ai.hint': '把照片先用生成式 AI 改成像素卡通画再做成图纸。需要 fal.ai API Key（注册见 fal.ai/dashboard/keys）。',
    'ai.key': 'API Key',
    'ai.style': '风格',
    'ai.style-pixel': '像素艺术',
    'ai.style-stardew': 'Stardew Valley',
    'ai.style-terraria': 'Terraria',
    'ai.style-8bit-game': '8-bit 游戏',
    'ai.style-anime': '日系动漫',
    'ai.style-ghibli': '吉卜力',
    'ai.strength': '改造强度',
    'ai.generate': '生成卡通版',
    'ai.busy': '生成中…',
    'ai.no-image': '请先上传一张照片',
    'ai.no-key': '请先填写 fal.ai API Key',
    'ai.fail': '生成失败：',
    'ai.done': '生成完成，已替换原图重新转换',
    'image.brightness': '亮度',
    'image.contrast': '对比度',
  ...
  en: {
    ...
    'image.mode-sample': 'Sharp edges',
    'image.mode-sample-hint': '?',
    'image.bg-tol': 'BG tolerance',
    'image.bg-local': 'Local cutout',
    'image.bg-ai': 'AI cutout',
    'image.bg-restore': 'Restore',
    'image.bg-busy': 'AI cutout in progress…',
    'image.bg-done': 'Background removed',
    'image.bg-fail': 'Cutout failed: ',
    'image.bg-restored': 'Restored original',
    ...
    'image.style-8bit': '8-bit retro',
    'image.style-comic': 'Comic outline',
    'image.style-watercolor': 'Watercolor',
    'image.style-noir': 'Monochrome',

    'ai.title': 'AI photo → cartoon (advanced)',
    'ai.hint': 'Use generative AI to repaint the photo as pixel-cartoon art before bead conversion. Needs a fal.ai API key (get one at fal.ai/dashboard/keys).',
    'ai.key': 'API Key',
    'ai.style': 'Style',
    'ai.style-pixel': 'Pixel art',
    'ai.style-stardew': 'Stardew Valley',
    'ai.style-terraria': 'Terraria',
    'ai.style-8bit-game': '8-bit game',
    'ai.style-anime': 'Anime',
    'ai.style-ghibli': 'Ghibli',
    'ai.strength': 'Strength',
    'ai.generate': 'Generate cartoon',
    'ai.busy': 'Generating…',
    'ai.no-image': 'Upload a photo first',
    'ai.no-key': 'Enter your fal.ai API key first',
    'ai.fail': 'Generation failed: ',
    'ai.done': 'Done — repainted image converted to pattern',
